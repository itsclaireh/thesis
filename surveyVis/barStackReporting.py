...
def barStackRep(face,yout,insta,twit,snap,redd,tumbl,other):
    ...
    #plt.tight_layout();
    #fig = plt.figure(1);
    plt.savefig("stackReporting.pdf", bbox_inches="tight");
    plt.savefig("stackReporting.png", bbox_inches="tight")
    plt.show();
