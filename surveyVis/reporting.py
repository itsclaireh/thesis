...
def barchartRep(face,yout,insta,twit,snap,redd,tumbl,other):
    ...
    plt.title('Ability to Report Sexual Harassment')
    plt.xticks(index+bar_width*1.5, objects,rotation=45, horizontalalignment='right');
    plt.legend();
    plt.tight_layout();

    plt.savefig("pdfs/barReporting.pdf", bbox_inches="tight");
    plt.savefig("pngs/barReporting.png", bbox_inches="tight");
    plt.show();
    ...
    plt.savefig("pdfs/stackReporting.pdf", bbox_inches="tight");
    plt.savefig("pngs/stackReporting.png", bbox_inches="tight")
    plt.show();
